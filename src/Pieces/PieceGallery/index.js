...
export class PieceGallery extends Component {
  constructor() {
    super();
    ...
    this.images = [{
      ...
      imageSet: [{
          srcSet: `${PREFIX_URL}2.jpg`, // cropped
          media: '(max-width: 1280px)',
        }, {
          srcSet: `${PREFIX_URL}2.jpg`, // default
  ...
  render() {
    return (
      ...
      <section className='image-gallery'>
        ...
        <div className='app-sandbox' style={{ visibility: 'hidden' }}>
            ...
            <ul className='app-checkboxes'>
              ...
              <li>
                <input
                  id='is_rtl'
                  type='checkbox'
                  onChange={this._handleCheckboxChange.bind(this, 'isRightToLeft')}
